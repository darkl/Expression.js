...
namespace ExpressionJs
{
    ...
    public class LessThanOrEqual : IExpressionConvertible<BinaryExpression>
    {
        [JsonProperty("left")]
        ...
        {
            return builder.LessThanOrEqual(Left.GetExpression(builder), Right.GetExpression(builder));
        }
    }
}